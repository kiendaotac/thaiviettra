    <div class="site-main">
        ...
        <div class="ttm-bgcolor-primary">
            ...
            <section
                class="section-block module_service process-section ttm-bgimage-yes bg-img6 ttm-bg res-991-margin_top_0 ttm-row perfomance-section bg-layer-equal-height product-detail clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
