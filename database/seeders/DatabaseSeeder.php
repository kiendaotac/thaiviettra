...
//        $this->command->info('Shop brands created.');
        ...
        $categoriesData = [
            [
                'name' => 'Trà phổ thông',
                'slug' => 'tra-pho-thong',
                'description' => 'Trà Móc Câu – một loại trà xanh nổi tiếng của trà Tân Cương nói riêng và trà Thái Nguyên nói chung, một vùng đất được mệnh danh là xứ trà với rất nhiều loại trà ngon và trong đó có trà móc câu.',
                'is_visible' => true,
            ],
            [
                'name' => 'Trà cao cấp',
